...
// Get all blueprints
export const getAll = async (): Promise<Blueprint[]> => {
...
// Get blueprint by ID
export const getById = async (id: string): Promise<Blueprint> => {
...
export const create = async (blueprint: Omit<Blueprint, 'id' | 'createdAt' | 'updatedAt'>): Promise<Blueprint> => {
  const response = await fetch(`${API_BASE_URL}/blueprints`, {
    method: 'POST',
    headers: {
...
// Update a blueprint
export const update = async (id: string, blueprint: Partial<Blueprint>): Promise<Blueprint> => {
  const response = await fetch(`${API_BASE_URL}/blueprints/${id}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
